# signals.py - مع محرك الانفجار المبكر
import logging
import asyncio
...
class SignalEngine:
    ...
    async def evaluate(self) -> Dict:
        ...
        # 🔥 محرك الانفجار المبكر (Early Explosion Detection)
        self.is_explosion = False
        ...
        # شروط الإشارة (مع مراعاة الانفجار)
        if self.is_explosion:
            actual_threshold = 4.0  # عتبة منخفضة للانفجارات
